...
/* USB HID Power Device page (0x84) — additional status/mode */
#define HID_USAGE_PD_BOOST                  USAGE(0x84, 0x6E)
#define HID_USAGE_PD_BUCK                   USAGE(0x84, 0x6F)
#define HID_USAGE_PD_CONFIG_APPARENT_POWER  USAGE(0x84, 0x43)
...
#define HID_USAGE_BS_REMAINING_TIME_LIMIT   USAGE(0x85, 0x2A)
...
#define HID_USAGE_BS_FULLY_CHARGED          USAGE(0x85, 0x46)
#define HID_USAGE_BS_NEED_REPLACEMENT       USAGE(0x85, 0x4B)
#define HID_USAGE_BS_OVERLOAD               USAGE(0x85, 0x65)
...
/* APC vendor-specific (page 0xFF86) */
#define HID_USAGE_APC_GENERAL_COLLECTION    USAGE(0xFF86, 0x05)
#define HID_USAGE_APC_ENVIRONMENT           USAGE(0xFF86, 0x06)
#define HID_USAGE_APC_PROBE1                USAGE(0xFF86, 0x07)
#define HID_USAGE_APC_BATT_REPLACE_DATE     USAGE(0xFF86, 0x16)
#define HID_USAGE_APC_BATT_CAP_STARTUP      USAGE(0xFF86, 0x19)
#define HID_USAGE_APC_FIRMWARE_REV          USAGE(0xFF86, 0x42)
#define HID_USAGE_APC_LINE_FAIL_CAUSE       USAGE(0xFF86, 0x52)
#define HID_USAGE_APC_STATUS_FLAG           USAGE(0xFF86, 0x60)
#define HID_USAGE_APC_SENSITIVITY           USAGE(0xFF86, 0x61)
#define HID_USAGE_APC_PANEL_TEST            USAGE(0xFF86, 0x72)

/* CPS vendor-specific (page 0xFF01) */
#define HID_USAGE_CPS_FIRMWARE_VERSION      USAGE(0xFF01, 0xD0)
#define HID_USAGE_CPS_INPUT_SENSITIVITY     USAGE(0xFF01, 0x43)
